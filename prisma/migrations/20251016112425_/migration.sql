/*
  ...
  - You are about to drop the column `subdivision_name` on the `votes` table. All the data in the column will be lost.
  - You are about to alter the column `subdivision_id` on the `votes` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
