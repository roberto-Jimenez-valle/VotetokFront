...
<nav
	class="fixed bottom-0 left-0 right-0 w-full bg-[#000000] flex justify-between items-center px-1 sm:px-4 py-1 sm:py-2 transition-transform duration-300 ease-in-out"
