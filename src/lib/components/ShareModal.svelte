<script lang="ts">
  ...
  $: selectedPalette =
    currentPalettes[selectedPaletteIndex] || currentPalettes[0];
  ...
  function shareWhatsApp() {
    const text = encodeURIComponent(
      `Vota en esta encuesta: ${pollTitle} ${shareUrl}`,
    );
    ...
    {:else}
      ...
      <div class="tab-content">
        ...
        <div class="code-box">
          <code>{embedCode}</code>
          <button
            class="copy-code-btn {copiedEmbed ? 'copied' : ''}"
