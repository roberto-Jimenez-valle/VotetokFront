<script lang="ts">
  ...
  const lightPalettes = [
    // Grises/Blancos
    { name: 'Cloud', bg: '#d0d2d4', sphere: '#bcc0c4', stroke: '#a8adb2', noData: '#c4c7ca' },
    { name: 'Pearl', bg: '#d3d3d3', sphere: '#c0c0c0', stroke: '#adadad', noData: '#c8c8c8' },
    { name: 'Silver', bg: '#c8cacc', sphere: '#b5b8bb', stroke: '#a1a5a9', noData: '#bdc0c3' },
    { name: 'Cream', bg: '#d7d7d7', sphere: '#c7c7c7', stroke: '#b7b7b7', noData: '#cfcfcf' },
    { name: 'Ivory', bg: '#d8d8d6', sphere: '#c8c8c4', stroke: '#b8b8b2', noData: '#d0d0cd' },
    // Púrpuras/Violetas
    { name: 'Lavender Mist', bg: '#d0cfe0', sphere: '#bdbccf', stroke: '#aaa8be', noData: '#c6c5d8' },
    { name: 'Lilac Dream', bg: '#d2d0e1', sphere: '#bfbdd1', stroke: '#aca9c0', noData: '#c8c6d9' },
    { name: 'Purple Haze', bg: '#c5c3d8', sphere: '#b2b0c5', stroke: '#9e9bb2', noData: '#bbb9ce' },
    { name: 'Violet Soft', bg: '#d8d0e0', sphere: '#c5bdd1', stroke: '#b0a8be', noData: '#cec6d8' },
    // Azules
    { name: 'Sky Whisper', bg: '#c8d7e1', sphere: '#b5c7d1', stroke: '#a0b6c0', noData: '#becfd9' },
    { name: 'Ice Blue', bg: '#c9d8e2', sphere: '#b6c8d2', stroke: '#a1b7c1', noData: '#bfd0da' },
    { name: 'Ocean Mist', bg: '#c0d0d8', sphere: '#adc0c8', stroke: '#98afb7', noData: '#b6c8d0' },
    { name: 'Steel Blue', bg: '#b8c8d0', sphere: '#a5b8c0', stroke: '#90a7af', noData: '#aec0c8' },
    // Cyan/Aqua/Turquesa
    { name: 'Aqua Light', bg: '#c0d8d8', sphere: '#adc8c8', stroke: '#98b7b7', noData: '#b6d0d0' },
    { name: 'Turquoise Soft', bg: '#b8e0d8', sphere: '#a5d0c8', stroke: '#90bfb6', noData: '#add8d0' },
    // Verdes
    { name: 'Mint Breeze', bg: '#c9d8d0', sphere: '#b6c8be', stroke: '#a1b7ab', noData: '#bfd0c6' },
    { name: 'Sage Whisper', bg: '#cad9d0', sphere: '#b7c9be', stroke: '#a2b8ab', noData: '#c0d1c6' },
    { name: 'Forest Mist', bg: '#c0d0c8', sphere: '#adc0b5', stroke: '#98afa0', noData: '#b6c8be' },
    { name: 'Emerald Light', bg: '#b8d0c8', sphere: '#a5c0b5', stroke: '#90afa0', noData: '#aec8be' },
    { name: 'Lime Light', bg: '#d0e0b8', sphere: '#c0d0a5', stroke: '#afbf90', noData: '#c8d8ad' },
    // Amarillos/Dorados
    { name: 'Gold Light', bg: '#e0d8b0', sphere: '#d0c89d', stroke: '#bfb688', noData: '#d8d0a6' },
    { name: 'Sand', bg: '#d8d0c8', sphere: '#c5bdb5', stroke: '#b0a89f', noData: '#cec6be' },
    { name: 'Beige', bg: '#d8d0c0', sphere: '#c5bdad', stroke: '#b0a898', noData: '#cec6b6' },
    // Naranjas/Marrones
    { name: 'Orange Light', bg: '#e0c8b8', sphere: '#d0b8a5', stroke: '#bfa690', noData: '#d8c0ad' },
    { name: 'Copper Soft', bg: '#e0c8b0', sphere: '#d0b89d', stroke: '#bfa688', noData: '#d8c0a6' },
    { name: 'Peach Silk', bg: '#dcd2ce', sphere: '#c9bfb9', stroke: '#b6aba4', noData: '#d6c8c3' },
    { name: 'Terracotta', bg: '#d0c0b8', sphere: '#bdada5', stroke: '#a89890', noData: '#c6b6ae' },
    // Rosas/Rojos
    { name: 'Rose Blush', bg: '#dcd0d3', sphere: '#c9bdc0', stroke: '#b6a9ad', noData: '#d6c6c9' },
    { name: 'Coral Soft', bg: '#d8c8c8', sphere: '#c5b5b5', stroke: '#b0a0a0', noData: '#cebebe' },
    { name: 'Pink Soft', bg: '#e0c0d0', sphere: '#d0adc0', stroke: '#bf98af', noData: '#d8b6c8' },
  ];
  ...
  onMount(() => {
    ...
    if (savedTheme) {
      ...
      console.log('[Theme] onMount - Estado del DOM tiene .dark:', hasDarkClass, 'isDark:', isDark);
      ...
      setTimeout(() => {
        console.log('[Theme] Disparando evento palettechange con paleta guardada');
        dispatch('palettechange', { ...savedPalette, isDark });
        window.dispatchEvent(new CustomEvent('palettechange', { detail: { ...savedPalette, isDark } }));
      ...
      setTimeout(() => {
        ...
        window.dispatchEvent(new CustomEvent('palettechange', { detail: { ...initialPalette, isDark } }));
      }, 200);
    }
  ...
  function handleMouseMove(e: MouseEvent) {
    if (e.buttons === 1) { // Si el botón está presionado
      const diff = Math.abs(e.clientX - startX);
      if (diff > 5) { // Umbral de 5px para considerar drag
        isDragging = true;
  ...
  function handleMouseUp(e: MouseEvent) {
    ...
    if (!isDragging && diff < 5) {
      ...
      const palettes = isDark ? darkPalettes : lightPalettes;
      currentPaletteColor = palettes[currentPaletteIndex % palettes.length].sphere;
      ...
      window.dispatchEvent(new CustomEvent('palettechange', { detail: { ...newPalette, isDark } }));
  ...
  function cyclePalette() {
    ...
    console.log('[Theme] cyclePalette - isDark:', isDark, 'clase .dark en DOM:', document.documentElement.classList.contains('dark'));
    const palettes = isDark ? darkPalettes : lightPalettes;
    ...
    console.log('[Theme] Disparando palettechange:', palette.name, 'isDark:', isDark);
  ...
  function checkForSavePrompt() {
    ...
    if (lastPaletteChangeTime > 0 && !showSaveModal && (now - lastPaletteChangeTime) >= 5000) {
    ...
    if (showSaveModal && modalShowTime > 0 && (now - modalShowTime) >= 4000) {
      console.log('[Theme] ⏰ 4 segundos pasados, cerrando modal automáticamente');
      showSaveModal = false;
      modalShowTime = 0;
    }
...
>
  <div class="toggle-track">
    <div class="toggle-icon" class:dark={isDark} class:pulse-effect={showPulse} style="background: {currentPaletteColor};">
      {#if isDark}
        <!-- Luna -->
...
{#if showSaveModal}
  <div class="save-snackbar">
    ...
    <button class="save-snackbar-close" onclick={dismissSaveModal} aria-label="Cerrar">
