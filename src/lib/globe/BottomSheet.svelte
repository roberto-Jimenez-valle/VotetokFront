...
>
  ...
  >
    <div class="nav-minimal" bind:this={navContainer}>
      ...
      {:else}
        ...
        <button class="nav-chip" onclick={() => onNavigateToView("world")}>
          Global
        </button>
      {/if}
      ...
      {#if selectedCountryName}
        ...
        {:else if !selectedSubdivisionName && !hasSubdivisions}
          ...
          <button class="nav-chip active" onclick={() => {}}>
            {selectedCountryName}
          </button>
        {:else}
          <!-- Country is not last - no dropdown -->
          <button class="nav-chip" onclick={() => onNavigateToView("country")}>
            {selectedCountryName}
          </button>
        {/if}
      {/if}
    ...
    {#if showSearch}
      <div class="nav-search-overlay">
        ...
        <input
          ...
          placeholder={navigationManager?.getCurrentLevel() === "world"
            ? "Buscar país..."
            : "Buscar región..."}
          bind:value={tagQuery}
                  ...
                  {#if result.id && result.id.includes(".")}
                    ...
                    {#if hasLevel3}
                      ...
                      <span class="hierarchy">
                        ...
                        <span class="hierarchy-subdivision"
                          >{result.parentName || "Subdivisión"}</span
                        >
                        <span class="hierarchy-separator">→</span>
        ...
        {#if showOptionsMenu}
          ...
          >
            ...
            >
              {#if fullscreenActive}
                <path
                  d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"
                />
              {:else}
                <path
  ...
  {#if state !== "expanded"}
    ...
    >
      ...
      <div class="floating-indicators-content"></div>
